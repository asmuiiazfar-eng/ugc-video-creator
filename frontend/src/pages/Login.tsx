...
export default function Login() {
  ...
  // Issue 6 fix: Google OAuth via Supabase
  const handleGoogleLogin = async () => {
    ...
    // On success, Supabase redirects the browser — no manual navigate() needed.
  };
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="card">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 disabled:opacity-60"
          >
            {googleLoading ? (
